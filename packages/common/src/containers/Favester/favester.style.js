...
import DomainBG from '../../assets/image/favester/background.jpg';
...
export const ConditionSectionWrapper = styled.section`
  position: relative;
`;

export const DomainServicesWrapper = styled.div`
  background-image: url(${DomainBG});
