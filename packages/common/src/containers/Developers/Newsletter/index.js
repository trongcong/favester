  ...
  return (
    <Box {...sectionWrapper} as="section">
      <Container>
        <NewsletterWrapper>
          <Box {...textArea}>
            <Heading content="Developer newsletter" {...title} />
            <Text
              content="Keep up to date with the latest happenings in the Favester developer world by subscribing to our weekly newsletter."
              {...description}
            />
          </Box>
          <Box {...buttonArea}>
